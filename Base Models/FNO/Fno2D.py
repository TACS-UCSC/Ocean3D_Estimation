...
class FNO2d(nn.Module):
    def __init__(self, in_channels, out_channels, modes1, modes2, width):
        ...
        self.p = nn.Linear(in_channels+2, self.width) # input channel is 12: the solution of the previous 10 timesteps + 2 locations (u(t-10, x, y), ..., u(t-1, x, y),  x, y)
        ...
        self.q = MLP(self.width, out_channels, self.width * 4) # output channel is 1: u(x, y)
