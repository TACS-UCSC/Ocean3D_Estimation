...
**Dataset**:
This work uses GLORYS subsurface states, including temperature, salinity, zonal velocity (U), and meridional velocity (V), together with satellite surface observations as conditional inputs. The dataset is publicly available on Zenodo:
https://zenodo.org/records/19116637
